...
#ident	"@(#)sh:common/cmd/sh/ctype.h	1.10.5.2"
#ident "$Header$"
/*
 *	UNIX shell
 */
...
#define eofmeta(c)	((c) == (unsigned char)EOF || (((c)&QUOTE)==0 && _ctype1[c]&(_META|T_EOF)))
#define qotchar(c)	(((c)&QUOTE)==0 && _ctype1[c]&(T_QOT))
#define eolchar(c)	((c) == (unsigned char)EOF || (((c)&QUOTE)==0 && _ctype1[c]&(T_EOR|T_EOF)))
