...
#ident	"@(#)sh:common/cmd/sh/cmd.c	1.12.8.4"
#ident "$Header$"
/*
 * UNIX shell
 */
	...
	case 0:	/*FALLTHROUGH*/
		{
			...
			register struct argnod *argp;
			register struct argnod **settail;
	...
	struct ionod *lastio;
{
	...
	if (fndef)
		iop->ioname = make(wdarg->argval, 0);
	else
